...
index resolves it; see [mirror Docker Hub official images](hub-official-images.md).
...
- The full role walkthrough, hosted and virtual as well as proxy: [run a container registry](container-registry.md).
