...
minutes and builds on [getting started](getting-started.md).
...
- [Run a container registry](../guides/container-registry.md): the three roles in detail, plus deleting images you no
  longer want.
