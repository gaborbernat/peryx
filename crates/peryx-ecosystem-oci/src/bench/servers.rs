...
pub(super) fn reports(servers: &[BenchServer]) -> Vec<Server> {
    servers
        ...
        .map(|server| Server {
            ...
            version: server.report.version,
            base_url: Arc::clone(&server.report.base_url),
            probe: Arc::clone(&server.report.probe),
            command: None,
            setup: None,
            configure: None,
            teardown: None,
...
fn peryx() -> BenchServer {
    BenchServer {
        report: Server {
            ...
            base_url: Arc::new(peryx_base),
            probe: Arc::new(api_root),
            command: None,
            setup: None,
            configure: None,
            teardown: None,
...
fn direct() -> BenchServer {
    BenchServer {
        report: Server {
            ...
            version: "",
            base_url: Arc::new(docker_hub_base),
            probe: Arc::new(api_root),
            command: None,
            setup: None,
            configure: None,
...
fn distribution() -> BenchServer {
    BenchServer {
        report: Server {
            ...
            version: DISTRIBUTION_IMAGE,
            base_url: Arc::new(local_base),
            probe: Arc::new(api_root),
            command: None,
            setup: None,
            configure: None,
