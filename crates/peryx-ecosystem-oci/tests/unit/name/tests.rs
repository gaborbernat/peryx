...
fn test_referrers_route() {
    ...
    // Malformed digests still route so handlers can return `400`.
    assert_eq!(
...
fn test_valid_content_digest_enforces_the_registered_length() {
    for ok in [
        ...
        // Unregistered algorithms use the general digest grammar.
...
#[rstest]
#[case::missing("/v2/manifests/latest")]
#[case::empty_component("/v2/app//manifests/latest")]
#[case::parent_component("/v2/../secret/manifests/latest")]
#[case::uppercase_component("/v2/App/manifests/latest")]
fn test_invalid_repository_name_is_rejected(#[case] path: &str) {
...
#[test]
fn test_authority_key_cannot_collide_with_a_foreign_resource_key() {
