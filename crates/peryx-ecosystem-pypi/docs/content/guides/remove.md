...
name and the action word are the same. The following paths use a project whose normalized name is `yank`; names
...
- Why the match agrees with the served page, and why peryx addresses these names:
  [equivalent version spellings](@/uploads.md#equivalent-version-spellings) and
  [verb-named projects](@/uploads.md#verb-named-projects)
