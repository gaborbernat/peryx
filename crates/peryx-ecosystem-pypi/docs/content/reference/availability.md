...
See [Distributed ingress admission](@/reference/uploads.md#distributed-ingress-admission) for request behavior and
[Finalizing admitted content](@/core/availability/finalization.md) for the coordinator transaction.
