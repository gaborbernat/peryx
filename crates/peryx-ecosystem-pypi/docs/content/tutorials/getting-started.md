...
Point peryx at pypi.org, install packages through it with [pip](https://pip.pypa.io/) and uv, publish a package of your
...
dependency trees by fetching small `.metadata` files rather than whole wheels. Inspect the metrics endpoint:
