...
- The exact rules across JSON, HTML, and legacy JSON: [Simple API serving](@/reference/simple-api.md)
- Diagnose a real mirror or move a tool off the marker: [diagnose Simple API serving](@/guides/simple-api.md)
- Why peryx serves this way: [what peryx serves on the Simple API](@/serving.md) </content>
