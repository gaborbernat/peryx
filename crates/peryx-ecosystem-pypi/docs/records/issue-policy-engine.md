...
peryx currently accepts upstream artifacts and local uploads based on protocol shape and local index configuration. It
...
- peryx enforces policy consistently across upload, mirror ingestion, artifact fetch, and Simple API output.
