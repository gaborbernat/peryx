...
/// The ecosystem a staged write belongs to. Carried on the intent for the finalization and drain paths;
/// admission turns on the content binding and idempotency key, never the ecosystem.
