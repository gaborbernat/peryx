...
pub enum UpstreamError {
    ...
    #[error("no upstream source is eligible to serve this request")]
    NoEligibleSource,
}
...
impl UpstreamError {
    ...
    pub fn user_message(&self) -> String {
        match self {
            ...
            Self::NoEligibleSource => "no upstream source is eligible to serve this request".to_owned(),
        }
    }
}
