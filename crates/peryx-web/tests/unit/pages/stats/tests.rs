...
fn stats_body_renders_each_drill_level() {
    let value = serde_json::json!({
        ...
        "routes": {"root/cache": {"base": {"pages": 4, "reads": 2, "bytes": 2048, "writes": 1}}},
        "resources": {"artifact": {"base": {"pages": 4}}},
        "artifacts": {"artifact.bin": {"reads": 2, "bytes": 2048}},
    });
    for (route, resource, label, breadcrumb, row) in [
        (
            None,
            None,
            "Index",
            r#"<p class="breadcrumb"><span>usage</span></p>"#,
            r#"<td><a href="/stats?index=root%2Fcache">root/cache</a></td>"#,
        ),
        (
            Some("root/cache"),
            None,
            ...
            r#"<td><a href="/stats?index=root%2Fcache&amp;resource=artifact">artifact</a></td>"#,
        ),
        (
            Some("root/cache"),
            Some("artifact"),
