...
denies the action. The [access model](@/core/access/authentication.md) defines principals, actions, and resource-glob
grants per index.
...
- The keys and defaults: [authentication and access control](@/core/access/authentication.md)
- Point a secret at a file, task by task: [control access to an index](@/core/access/control-access.md)
- Source ownership for contributors: [code architecture](@/contributing/architecture.md)
