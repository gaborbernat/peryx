...
An ecosystem can add browser views without changing the shared shell. It supplies:
...
- [Monitoring data model](@/core/operations/monitor.md)
- [Search API](@/core/repositories/search.md)
- [Trash API](@/core/repositories/trash.md)
