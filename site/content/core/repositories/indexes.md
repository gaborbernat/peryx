...
retain it. Each ecosystem reports its references; placement and reclamation use those reports without parsing
ecosystem-specific metadata.

## Related documentation

- [Ecosystem owner documentation](@/ecosystems/_index.md)
- [Shared terminology](@/core/reference/glossary.md)
- [Registered wire standards](@/core/reference/standards.md)
