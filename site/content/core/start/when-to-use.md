...
Each ecosystem retains its client protocol behavior.
...
availability use shared services. Each ecosystem preserves its protocol behavior.
...
- [Install and start peryx](@/core/start/getting-started.md)
- [Understand index roles](@/core/repositories/indexes.md)
- [Read the architecture](@/contributing/runtime-architecture.md)
