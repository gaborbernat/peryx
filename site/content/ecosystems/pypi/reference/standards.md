+++
title = "Standards"
description = "Packaging PEPs and specifications implemented by the PyPI ecosystem."
weight = 1
+++

peryx implements the Python index standards listed below. The
[Simple Repository API](https://packaging.python.org/en/latest/specifications/simple-repository-api/) consolidates most
...
The [upload reference](@/ecosystems/pypi/reference/uploads.md) lists the accept and reject tables with the exact error
strings.
...
Some upstreams implement only part of the stack; [Artifactory](https://jfrog.com/artifactory/) and GitLab may serve HTML
